                            ...
                            <Text>
                              ...
                              >
                                <ListItem>
                                  <Text
                                    color={"#1B4173"}
                                    fontSize={["lg", "lg", "2.2vh", "sm", "lg"]}
                                  >
                                    HoME dapat diakses secara online melalui
                                    website
                                    <span
                                      style={{
                                        fontWeight: "bold",
                                ...
                                <ListItem>
                                  <Text
                                    ...
                                    fontSize={["lg", "lg", "2.1vh", "sm", "lg"]}
                                  >
                                    Kamu perlu melakukan registrasi terlebih
                                    dahulu untuk mengkonfirmasi NIM dan token
                                    kamu di website MAXIMA tersebut.
                                  </Text>
                                </ListItem>
                                <ListItem>
                                  <Text
                                    ...
                                    fontSize={["lg", "lg", "2.1vh", "sm", "lg"]}
                                  >
                                    Setelah registrasi, ikuti instruksi untuk
                                    mengakses HoME pada website agar kamu dapat
                                    melihat berbagai cluster organisasi yang ada
                                    di UMN. Klik pada cluster yang ingin kamu
                                    kunjungi untuk melihat organisasi-organisasi
