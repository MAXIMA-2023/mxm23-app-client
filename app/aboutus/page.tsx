...
const AboutUs: NextPage = () => {
  ...
  return (
    <Layout title={"MAXIMA 2023 - About Us"} backButton showSponsorFooter sponsorFooterMarginTop={"4.5em"}>
      <Flex
        minH={"100vh"}
        bgImage={[
              ...
              <Center w={"100%"} h={["100%"]}>
                <Box>
                  <Center mt={["1em", "1em", "0em", "1em", "1em"]}>
                    <Img src={"https://storage.googleapis.com/mxm23-app-client/webps/webps/public/assets/aboutus/AboutUs.svg"} w={["12.5em", "15em", "42vw", "20em", "27em"]}></Img>
                  </Center>
