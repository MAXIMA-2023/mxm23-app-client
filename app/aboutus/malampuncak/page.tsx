...
const MalamPuncak: NextPage = () => {
  return (
    <Layout title={"MAXIMA 2023 - About Us (Malam Puncak)"} backButton showSponsorFooter sponsorFooterMarginTop={"4.5em"}>
      <Flex
        minH={"100vh"}
        bgImage={[
          ...
          <Center>
            ...
            >
              <Center w={"100%"} h={["100%"]}>
                <Box>
                  <Center mt={"0em"}>
                    <Img src={"https://storage.googleapis.com/mxm23-app-client/webps/webps/public/assets/aboutus/AboutUs_Malpun.svg"} w={["10em", "15em", "40vw", "15em", "18em"]}></Img>
                  </Center>
