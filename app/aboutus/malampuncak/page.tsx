                ...
                <Box>
                  ...
                  <Center display={["none", "block"]}>
                    <Stack direction={"column"} spacing={[5, 5, 7, 5, 8]}>
                      ...
                      >
                        ...
                        adalah acara penutup dari rangkaian kegiatan MAXIMA.
                        Malam Puncak MAXIMA juga menjadi ajang bagi organisator
                        untuk semakin mengenalkan organisasi masing-masing
                        kepada mahasiswa lewat berbagai penampilan di atas
                        panggung dan booth-booth yang tersedia.
                      </Text>
                      <Center>
                        <Text
                          w={["50%", "80%", "70%", "60%", "50%"]}
                        ...
                        >
                          <span style={{ fontWeight: "1000" }}>
                            Pelaksanaan Malam Puncak{" "}
                          </span>{" "}
                          <br /> akan dilakukan pada tanggal <br /> 7 Oktober
                          2023
                        </Text>
                      </Center>
                    </Stack>
                  ...
                  <Center display={["block", "none"]}>
                    <Stack direction={"column"} spacing={[4, 4, 7, 5, 8]}>
                      <Text
                        fontSize={["15px", "15px", "2.3vh", "md", "xl"]}
                        color={"#1B4173"}
                        textAlign={"center"}
                      >
